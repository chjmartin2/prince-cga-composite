...
- Editor: **Prince DAT Explorer v0.6.3**. Adds editable wall-overlay previews,
  complete artwork ZIP exchange, readable overlay selectors, and support for
  customized actor DAT references in linked ORIENT editing. Existing composite and orientation editing remain available.
...
[Prince DAT Explorer v0.6.3 release](https://github.com/chjmartin2/prince-cga-composite/releases/tag/v0.6.3).
...
- `editor/` - v0.5.2 source, documentation, and 194-test suite.
