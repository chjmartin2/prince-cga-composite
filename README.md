...
- Editor: **Prince DAT Explorer v0.6.4**. Adds separate Left/Right family-folder
  export/import, preservation of untouched ORIENT images, accurate imported
  transparency previews, and plain-palace previews for matching game projects.
...
[Prince DAT Explorer v0.6.4 release](https://github.com/chjmartin2/prince-cga-composite/releases/tag/v0.6.4).
...
- `editor/` - v0.6.4 source, documentation, and 223-test suite.
